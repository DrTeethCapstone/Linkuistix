...
function About() {
    ...
    const handleMouseLeave = () => {
        setWillImgState('./faces/pixelWill.png')
        setNoelImgState('./faces/pixelNoel.png')
        setBillImgState('./faces/pixelBill.png')
        setDrewImgState('./faces/pixelDrew.png')
        setBilalImgState('./faces/pixelBilal.png')
    }

    const handleMouseEnter = () => {
        setWillImgState('./faces/pixelWill-eyes.png')
        setNoelImgState('./faces/pixelNoel-eyes.png')
        setBillImgState('./faces/pixelBill-eyes.png')
        setDrewImgState('./faces/pixelDrew-eyes.png')
        setBilalImgState('./faces/pixelBilal-eyes.png')
    }
            ...
            <div className='about-container'>
                <div className='about-game-container'>
                    ...
                    <h5 ><a
                        ...
                        href='https://github.com/DrTeethCapstone/capstone-ml-three-firebase'>Project Github</a></h5>
                ...
                <div className='dev-container'>
                    ...
                    <div className='bio-container'>
                        ...
                        <h5>Will Siddons</h5>
                        <p onMouseLeave={() => setWillImgState('./faces/pixelWill.png')} onMouseEnter={() => setWillImgState('./faces/pixelWill-mouth.png')}><a href='https://www.linkedin.com/in/willsiddons/'>LinkedIn</a></p>
                    </div>
                    <div className='bio-container'>
                        ...
                        <h5>Bill Munkacsy</h5>
                        <p onMouseLeave={() => setBillImgState('./faces/pixelBill.png')} onMouseEnter={() => setBillImgState('./faces/pixelBill-cat.png')}><a href='https://www.linkedin.com/in/williammunkacsy/'>LinkedIn</a></p>
                    </div>
                    <div className='bio-container'>
                        ...
                        <h5>Noel Benford</h5>
                        <p onMouseLeave={() => setNoelImgState('./faces/pixelNoel.png')} onMouseEnter={() => setNoelImgState('./faces/pixelNoel-pirate.png')}><a href='https://www.linkedin.com/in/noelbenford/'>LinkedIn</a></p>
                    </div>
                    <div className='bio-container'>
                        ...
                        <h5>Andrew Dobson</h5>
                        <p onMouseLeave={() => setDrewImgState('./faces/pixelDrew.png')} onMouseEnter={() => setDrewImgState('./faces/pixelDrew-dog.png')}><a href='https://www.linkedin.com/in/tandrewlopez/'>LinkedIn</a></p>
                    </div>
                    <div className='bio-container'>
                        ...
                        <h5>Bilal Abbas</h5>
                        <p onMouseLeave={() => setBilalImgState('./faces/pixelBilal.png')} onMouseEnter={() => setBilalImgState('./faces/pixelBilal-crown.png')}><a href='https://www.linkedin.com/in/babbasuk/'>LinkedIn</a></p>
                    </div>
                </div>
            </div>
        </>
